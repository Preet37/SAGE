...
- [Educator Registry](educators/_index.md) — 12 educator profiles
- [Resource Index](resources/_index.md) — 50 topic resource entries
- [Concept Map](concept-map.md) — 3-level hierarchy
