...
*   [How to use Structured Outputs](https://openai.com/index/introducing-structured-outputs-in-the-api/#how-to-use-structured-outputs)
*   [Safe Structured Outputs](https://openai.com/index/introducing-structured-outputs-in-the-api/#safe-structured-outputs)
*   [Native SDK support](https://openai.com/index/introducing-structured-outputs-in-the-api/#native-sdk-support)
*   [Additional use cases](https://openai.com/index/introducing-structured-outputs-in-the-api/#additional-use-cases)
*   [Dynamically generating user interfaces based on the user’s intent](https://openai.com/index/introducing-structured-outputs-in-the-api/#dynamically-generating-user-interfaces-based-on-the-users-intent)
*   [Separating a final answer from supporting reasoning or additional commentary](https://openai.com/index/introducing-structured-outputs-in-the-api/#separating-a-final-answer-from-supporting-reasoning-or-additional-commentary)
*   [Extracting structured data from unstructured data](https://openai.com/index/introducing-structured-outputs-in-the-api/#extracting-structured-data-from-unstructured-data)
*   [Under the hood](https://openai.com/index/introducing-structured-outputs-in-the-api/#under-the-hood)
*   [Constrained decoding](https://openai.com/index/introducing-structured-outputs-in-the-api/#constrained-decoding)
*   [Alternate approaches](https://openai.com/index/introducing-structured-outputs-in-the-api/#alternate-approaches)
*   [Limitations and restrictions](https://openai.com/index/introducing-structured-outputs-in-the-api/#limitations-and-restrictions)
*   [Availability](https://openai.com/index/introducing-structured-outputs-in-the-api/#availability)
*   [Acknowledgements](https://openai.com/index/introducing-structured-outputs-in-the-api/#acknowledgements)
...
`1from pydantic import BaseModel23from openai import OpenAI456class Step(BaseModel):7    explanation: str8    output: str91011class MathResponse(BaseModel):12    steps: list[Step]13    final_answer: str141516client = OpenAI()1718completion = client.beta.chat.completions.parse(19    model="gpt-4o-2024-08-06",20    messages=[21        {"role": "system", "content": "You are a helpful math tutor."},22        {"role": "user", "content": "solve 8x + 31 = 2"},23    ],24    response_format=MathResponse,25)2627message = completion.choices[0].message28if message.parsed:29    print(message.parsed.steps)30    print(message.parsed.final_answer)31else:32    print(message.refusal)`
...
Landing page for a gardener Sign up screen for an app Stock price widget
