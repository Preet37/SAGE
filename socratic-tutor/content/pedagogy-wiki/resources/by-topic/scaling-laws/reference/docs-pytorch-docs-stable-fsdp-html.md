...
# Title: FullyShardedDataParallel — PyTorch 2.11 documentation
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L118)[#](#torch.distributed.fsdp.FullyShardedDataParallel) A wrapper for sharding module parameters across data parallel workers.
This is inspired by
...
, FSDP supports mixing frozen and non-frozen parameters, but it’s recommended to avoid doing so to prevent higher than expected gradient memory usage.As of PyTorch 1.12, FSDP offers limited support for shared parameters. If enhanced shared parameter support is needed for your use case, please post in
[this issue](https://github.com/pytorch/pytorch/issues/77724).You should avoid modifying the parameters between forward and backward without using the
summon_full_params
context, as the modifications may not persist.
- Parameters:
module (
[nn.Module](generated/torch.nn.Module.html#torch.nn.Module)) – This is the module to be wrapped with FSDP.process_group (Optional[Union[
[ProcessGroup](distributed._dist2.html#torch.distributed._dist2.ProcessGroup), Tuple[[ProcessGroup](distributed._dist2.html#torch.distributed._dist2.ProcessGroup),[ProcessGroup](distributed._dist2.html#torch.distributed._dist2.ProcessGroup)]]]) – This is the process group over which the model is sharded and thus the one used for FSDP’s all-gather and reduce-scatter collective communications. IfNone
...
[nn.Module](generated/torch.nn.Module.html#torch.nn.Module),[bool](https://docs.python.org/3/library/functions.html#bool),[int](https://docs.python.org/3/library/functions.html#int)],[bool](https://docs.python.org/3/library/functions.html#bool)], ModuleWrapPolicy, CustomPolicy]]) –This specifies a policy to apply FSDP to submodules of
module
...
otherwise. For both cases, the implementation should only initialize the parameters/buffers of the module, not those of its submodules. This is to avoid re-initialization. In addition, FSDP also supports deferred initialization via torchdistX’s ([pytorch/torchdistX](https://github.com/pytorch/torchdistX))deferred_init()
...
.device_mesh (Optional[
[DeviceMesh](distributed.html#torch.distributed.device_mesh.DeviceMesh)]) – DeviceMesh can be used as an alternative to process_group. When device_mesh is passed, FSDP will use the underlying process groups for all-gather and reduce-scatter collective communications. Therefore, these two args need to be mutually exclusive. For hybrid sharding strategies such asShardingStrategy.HYBRID_SHARD
, users can pass in a 2D DeviceMesh instead of a tuple of process groups. For 2D FSDP + TP, users are required to pass in device_mesh instead of process_group. For more DeviceMesh info, please visit:[https://pytorch.org/tutorials/recipes/distributed_device_mesh.html](https://pytorch.org/tutorials/recipes/distributed_device_mesh.html)
-
apply(fn)
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L569)[#](#torch.distributed.fsdp.FullyShardedDataParallel.apply) Apply
fn
recursively to every submodule (as returned by.children()
) as well as self.Typical use includes initializing the parameters of a model (see also
[torch.nn.init](nn.init.html#nn-init-doc)).Compared to
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1073)[#](#torch.distributed.fsdp.FullyShardedDataParallel.clip_grad_norm_) Clip the gradient norm of all parameters.
...
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1555)[#](#torch.distributed.fsdp.FullyShardedDataParallel.flatten_sharded_optim_state_dict) Flatten a sharded optimizer state-dict.
...
-
forward(*args, **kwargs)
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L835)[#](#torch.distributed.fsdp.FullyShardedDataParallel.forward) Run the forward pass for the wrapped module, inserting FSDP-specific pre- and post-forward sharding logic.
- Return type:
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L546)[#](#torch.distributed.fsdp.FullyShardedDataParallel.fsdp_modules) Return all nested FSDP instances.
...
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1376)[#](#torch.distributed.fsdp.FullyShardedDataParallel.full_optim_state_dict) Return the full optimizer state-dict.
...
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L753)[#](#torch.distributed.fsdp.FullyShardedDataParallel.get_state_dict_type) Get the state_dict_type and the corresponding configurations for the FSDP modules rooted at
module
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L975)[#](#torch.distributed.fsdp.FullyShardedDataParallel.named_buffers) Return an iterator over module buffers, yielding both the name of the buffer and the buffer itself.
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L994)[#](#torch.distributed.fsdp.FullyShardedDataParallel.named_parameters) Return an iterator over module parameters, yielding both the name of the parameter and the parameter itself.
Intercepts parameter names and removes all occurrences of the FSDP-specific flattened parameter prefix when inside the
context manager.summon_full_params()
-
no_sync()
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1033)[#](#torch.distributed.fsdp.FullyShardedDataParallel.no_sync) Disable gradient synchronizations across FSDP instances.
...
- Return type:
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1796)[#](#torch.distributed.fsdp.FullyShardedDataParallel.optim_state_dict) Transform the state-dict of an optimizer corresponding to a sharded model.
...
[str](https://docs.python.org/3/library/stdtypes.html#str), Any]
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1892)[#](#torch.distributed.fsdp.FullyShardedDataParallel.optim_state_dict_to_load) Convert an optimizer state-dict so that it can be loaded into the optimizer associated with the FSDP model.
Given a
optim_state_dict
that is transformed through, it gets converted to the flattened optimizer state_dict that can be loaded tooptim_state_dict()
optim
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1982)[#](#torch.distributed.fsdp.FullyShardedDataParallel.register_comm_hook) Register a communication hook.
...
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1673)[#](#torch.distributed.fsdp.FullyShardedDataParallel.rekey_optim_state_dict) Re-keys the optimizer state dict
optim_state_dict
...
[str](https://docs.python.org/3/library/stdtypes.html#str), Any]
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1594)[#](#torch.distributed.fsdp.FullyShardedDataParallel.scatter_full_optim_state_dict) Scatter the full optimizer state dict from rank 0 to all other ranks.
...
[str](https://docs.python.org/3/library/stdtypes.html#str), Any]
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L626)[#](#torch.distributed.fsdp.FullyShardedDataParallel.set_state_dict_type) Set the
...
[OptimStateDictConfig](#torch.distributed.fsdp.OptimStateDictConfig)]) – the configuration for the optimizer state dict.
- Returns:
A StateDictSettings that include the previous state_dict type and configuration for the module.
- Return type:
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1481)[#](#torch.distributed.fsdp.FullyShardedDataParallel.shard_full_optim_state_dict) Shard a full optimizer state-dict.
Remaps the state in
full_optim_state_dict
to flattened parameters instead of unflattened parameters and restricts to only this rank’s part of the optimizer state. The first argument should be the return value of.full_optim_state_dict()
Example:
...
[str](https://docs.python.org/3/library/stdtypes.html#str), Any]
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1447)[#](#torch.distributed.fsdp.FullyShardedDataParallel.sharded_optim_state_dict) Return the optimizer state-dict in its sharded form.
The API is similar to
...
.
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L790)[#](#torch.distributed.fsdp.FullyShardedDataParallel.state_dict_type) Set the
...
- Return type:
-
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/fully_sharded_data_parallel.py#L862)[#](#torch.distributed.fsdp.FullyShardedDataParallel.summon_full_params) Expose full params for FSDP instances with this context manager.
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/api.py#L72)[#](#torch.distributed.fsdp.BackwardPrefetch) This configures explicit backward prefetching, which improves throughput by enabling communication and computation overlap in the backward pass at the cost of slightly increased memory usage.
BACKWARD_PRE
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/api.py#L32)[#](#torch.distributed.fsdp.ShardingStrategy) This specifies the sharding strategy to be used for distributed training by
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/api.py#L111)[#](#torch.distributed.fsdp.MixedPrecision) This configures FSDP-native mixed precision training.
- Variables:
...
[collections.abc.Sequence](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[type](https://docs.python.org/3/library/functions.html#type)[[torch.nn.modules.module.Module](generated/torch.nn.Module.html#torch.nn.Module)]]) – (Sequence[Type[nn.Module]]): This specifies module classes to ignore for mixed precision when using anauto_wrap_policy
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/api.py#L229)[#](#torch.distributed.fsdp.CPUOffload) This configures CPU offloading.
- Variables:
offload_params (
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/api.py#L275)[#](#torch.distributed.fsdp.StateDictConfig) StateDictConfig
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/api.py#L292)[#](#torch.distributed.fsdp.FullStateDictConfig) FullStateDictConfig
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/api.py#L339)[#](#torch.distributed.fsdp.ShardedStateDictConfig) ShardedStateDictConfig
...
Warning
_use_dtensor
is a private field ofand it is used by FSDP to determine the type of state dict values. Users should not manually modifyShardedStateDictConfig
_use_dtensor
.
-
class torch.distributed.fsdp.OptimStateDictConfig(offload_to_cpu=True)
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/api.py#L358)[#](#torch.distributed.fsdp.OptimStateDictConfig) OptimStateDictConfig
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/api.py#L376)[#](#torch.distributed.fsdp.FullOptimStateDictConfig) - Variables:
rank0_only (
[bool](https://docs.python.org/3/library/functions.html#bool)) – IfTrue
, then only rank 0 saves the full state dict, and nonzero ranks save an empty dict. IfFalse
, then all ranks save the full state dict. (Default:False
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/api.py#L393)[#](#torch.distributed.fsdp.ShardedOptimStateDictConfig) ShardedOptimStateDictConfig
is a config class meant to be used withStateDictType.SHARDED_STATE_DICT
.- Variables:
_use_dtensor (
[bool](https://docs.python.org/3/library/functions.html#bool)) – IfTrue
...
Warning
_use_dtensor
is a private field ofand it is used by FSDP to determine the type of state dict values. Users should not manually modifyShardedOptimStateDictConfig
_use_dtensor
.
-
...
[torch.distributed.fsdp.api.StateDictConfig](#torch.distributed.fsdp.StateDictConfig), optim_state_dict_config:[torch.distributed.fsdp.api.OptimStateDictConfig](#torch.distributed.fsdp.OptimStateDictConfig))[[source]](https://github.com/pytorch/pytorch/blob/v2.11.0/torch/distributed/fsdp/api.py#L412)[#](#torch.distributed.fsdp.StateDictSettings)