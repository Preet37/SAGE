# Source: https://d2l.ai/chapter_attention-mechanisms/index.html
# Author: Dive into Deep Learning
# Author Slug: dive-into-deep-learning
# Title: Dive into Deep Learning (d2l.ai) — Attention Mechanisms
# Fetched via: browser
# Date: 2026-04-08
...
[Feb 2023] The book is forthcoming on Cambridge University Press (order). The Chinese version is the best seller at the largest Chinese online bookstore. Follow D2L's open-source project for the latest updates.
