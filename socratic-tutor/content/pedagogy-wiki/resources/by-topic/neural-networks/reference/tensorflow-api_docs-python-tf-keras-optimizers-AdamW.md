...
# Title: tf.keras.optimizers.AdamW | TensorFlow v2.16.1
...
Inherits From: [ Adam](https://www.tensorflow.org/api_docs/python/tf/keras/optimizers/Adam),
Optimizer
...
References:
[Loshchilov et al., 2019](https://arxiv.org/abs/1711.05101)[Kingma et al., 2014](http://arxiv.org/abs/1412.6980)foradam
[Reddi et al., 2018](https://openreview.net/pdf?id=ryQu7f-RZ)foramsgrad
.
Attributes | |
|---|---|
learning_rate
