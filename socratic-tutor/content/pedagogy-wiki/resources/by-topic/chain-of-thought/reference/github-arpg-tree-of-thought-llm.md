...
# Title: GitHub - arpg/tree-of-thought-llm: [NeurIPS 2023] Tree of Thoughts: Deliberate Problem Solving with Large Language Models
...
OPENAI_API_KEY
(see[here](https://help.openai.com/en/articles/5112595-best-practices-for-api-key-safety)). -
Install
tot
package in two ways:
...
Please cite the paper and star this repo if you use ToT and find it interesting/useful, thanks! Feel free to contact [shunyuyao.cs@gmail.com](mailto:shunyuyao.cs@gmail.com) or open an issue if you have any questions.
@misc{yao2023tree,
