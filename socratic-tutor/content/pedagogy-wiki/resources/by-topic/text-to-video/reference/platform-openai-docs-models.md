...
[GPT-5.4 New Best intelligence at scale for agentic, coding, and professional workflows Model ID gpt-5.4 [Reasoning](https://developers.openai.com/api/docs/guides/reasoning#get-started-with-reasoning) none low medium high xhigh Input price $2.50 / Input MTok Output price $15 / Output MTok Latency Fast Max output 128K tokens Context window 1M [Tools](https://platform.openai.com/api/docs/guides/tools) Functions, Web search, File search, Computer use Knowledge cutoff Aug 31, 2025](https://platform.openai.com/api/docs/models/gpt-5.4)[GPT-5.4 mini New Our strongest mini model yet for coding, computer use, and subagents Model ID gpt-5.4-mini [Reasoning](https://developers.openai.com/api/docs/guides/reasoning#get-started-with-reasoning) none low medium high xhigh Input price $0.75 / Input MTok Output price $4.50 / Output MTok Latency Faster Max output 128K tokens Context window 400K [Tools](https://platform.openai.com/api/docs/guides/tools) Functions, Web search, File search, Computer use Knowledge cutoff Aug 31, 2025](https://platform.openai.com/api/docs/models/gpt-5.4-mini)[GPT-5.4 nano New Our cheapest GPT-5.4-class model for simple high-volume tasks Model ID gpt-5.4-nano [Reasoning](https://developers.openai.com/api/docs/guides/reasoning#get-started-with-reasoning) none low medium high xhigh Input price $0.20 / Input MTok Output price $1.25 / Output MTok Latency Faster Max output 128K tokens Context window 400K [Tools](https://platform.openai.com/api/docs/guides/tools) Functions, Web search, File search, MCP Knowledge cutoff Aug 31, 2025](https://platform.openai.com/api/docs/models/gpt-5.4-nano)
