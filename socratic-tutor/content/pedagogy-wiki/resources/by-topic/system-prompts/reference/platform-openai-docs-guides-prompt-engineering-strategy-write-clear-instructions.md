# Source: https://platform.openai.com/docs/guides/prompt-engineering/strategy-write-clear-instructions
# Author: OpenAI
# Author Slug: openai
# Title: Prompt engineering (Write clear instructions) | OpenAI Platform Docs
# Fetched via: jina
# Date: 2026-04-09
...
Agents Vision Voice Fine-tuning

We looked everywhere but couldn’t find that page. Try searching our resource library or explore one of the options below.

[### Extend ChatGPT Learn how to build apps for ChatGPT using the Apps SDK. Start building](https://platform.openai.com/apps-sdk)[### Get started with Codex Try our coding agent in the IDE, CLI, or cloud. Start building](https://platform.openai.com/codex)[### Read our blog Catch up on insights for developers using OpenAI's products and models. See posts](https://platform.openai.com/blog)