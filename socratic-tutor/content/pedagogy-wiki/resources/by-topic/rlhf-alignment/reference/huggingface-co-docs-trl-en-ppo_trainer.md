...
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/ppo_trainer.py#L306)
...
Parameters
[args (](#trl.experimental.ppo.PPOTrainer.args)[experimental.ppo.PPOConfig](/docs/trl/v1.0.0/en/ppo_trainer#trl.experimental.ppo.PPOConfig)) — Training arguments.[processing_class (](#trl.experimental.ppo.PPOTrainer.processing_class)[PreTrainedTokenizerBase](https://huggingface.co/docs/transformers/v5.4.0/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase),[BaseImageProcessor](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/image_processor#transformers.BaseImageProcessor),[FeatureExtractionMixin](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin)or[ProcessorMixin](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/processors#transformers.ProcessorMixin)) — Class to process the data.[model (](#trl.experimental.ppo.PPOTrainer.model)torch.nn.Module
...
) — Reward model used to compute the rewards.[train_dataset (](#trl.experimental.ppo.PPOTrainer.train_dataset)[Dataset](https://huggingface.co/docs/datasets/v4.8.4/en/package_reference/main_classes#datasets.Dataset)) — Dataset for training.[value_model (](#trl.experimental.ppo.PPOTrainer.value_model)torch.nn.Module
) — Value model used to predict the value of a state.[data_collator (](#trl.experimental.ppo.PPOTrainer.data_collator)[DataCollatorWithPadding](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/data_collator#transformers.DataCollatorWithPadding), optional) — Data collator to batch and pad samples from the dataset. IfNone
, a default data collator is created using theprocessing_class
.[eval_dataset (](#trl.experimental.ppo.PPOTrainer.eval_dataset)[Dataset](https://huggingface.co/docs/datasets/v4.8.4/en/package_reference/main_classes#datasets.Dataset)ordict
of[Dataset](https://huggingface.co/docs/datasets/v4.8.4/en/package_reference/main_classes#datasets.Dataset), optional) — Dataset for evaluation.[optimizers (](#trl.experimental.ppo.PPOTrainer.optimizers)tuple
...
, the optimizer and the learning rate scheduler are created using the[create_optimizer_and_scheduler](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/trainer#transformers.Trainer.create_optimizer_and_scheduler)method.[callbacks (](#trl.experimental.ppo.PPOTrainer.callbacks)list
of[TrainerCallback](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/callback#transformers.TrainerCallback), optional) — Callbacks to use during training.[peft_config (](#trl.experimental.ppo.PPOTrainer.peft_config)PeftConfig
, optional) — PEFT configuration to use PEFT for training. IfNone
...
push_to_hub
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/transformers/trainer.py#L3992)
...
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/ppo_config.py#L22)
...
Configuration class for the [experimental.ppo.PPOTrainer](/docs/trl/v1.0.0/en/ppo_trainer#trl.experimental.ppo.PPOTrainer).
This class includes only the parameters that are specific to PPO training. For a full list of training arguments,
please refer to the [TrainingArguments](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/trainer#transformers.TrainingArguments) documentation. Note that default values in this class may
differ from those in [TrainingArguments](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/trainer#transformers.TrainingArguments).
Using [HfArgumentParser](https://huggingface.co/docs/transformers/v5.4.0/en/internal/trainer_utils#transformers.HfArgumentParser) we can turn this class into
...
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/modeling_value_head.py#L52)
( pretrained_model = None score_module = None supports_rm_adapter = False rm_adapter_name = None **kwargs )
Parameters
[pretrained_model (](#trl.experimental.ppo.PreTrainedModelWrapper.pretrained_model)[PreTrainedModel](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel)) — The model to be wrapped.[parent_class (](#trl.experimental.ppo.PreTrainedModelWrapper.parent_class)[PreTrainedModel](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel)) — The parent class of the model to be wrapped.[supported_args (](#trl.experimental.ppo.PreTrainedModelWrapper.supported_args)list
) — The list of arguments that are supported by the wrapper class.
Wrapper for a [PreTrainedModel](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel) implemented as a standard PyTorch torch.nn.Module
.
This class provides a compatibility layer that preserves the key attributes and methods of the original
[PreTrainedModel](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel), while exposing a uniform interface consistent with PyTorch modules. It enables
...
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/modeling_value_head.py#L438)
...
from_pretrained
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/modeling_value_head.py#L106)
...
or[PreTrainedModel](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel)) — The path to the pretrained model or its name.[*model_args (](#trl.experimental.ppo.PreTrainedModelWrapper.from_pretrained.*model_args)list
...
method. We also pre-process the kwargs to extract the arguments that are specific to the[PreTrainedModel](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel)class and the arguments that are specific to trl models. The kwargs also supportprepare_model_for_kbit_training
arguments frompeft
library.
Instantiates a new model from a pretrained model from transformers
. The pretrained model is loaded using the
from_pretrained
method of the [PreTrainedModel](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel) class. The arguments that are specific to the
[PreTrainedModel](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel) class are passed along this method and filtered out from the kwargs
argument.
...
push_to_hub
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/modeling_value_head.py#L509)
( *args **kwargs )
Push the pretrained model to the hub. This method is a wrapper around
[push_to_hub](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel.push_to_hub). Please refer to the documentation of
[push_to_hub](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel.push_to_hub) for more information.
save_pretrained
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/modeling_value_head.py#L523)
( *args **kwargs )
Save the pretrained model to a directory. This method is a wrapper around
[save_pretrained](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel.save_pretrained). Please refer to the documentation of
[save_pretrained](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel.save_pretrained) for more information.
Return the state_dict of the pretrained model.
AutoModelForCausalLMWithValueHead
class trl.experimental.ppo.AutoModelForCausalLMWithValueHead
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/modeling_value_head.py#L634)
...
[experimental.ppo.PreTrainedModelWrapper](/docs/trl/v1.0.0/en/ppo_trainer#trl.experimental.ppo.PreTrainedModelWrapper) and wraps a [PreTrainedModel](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel) class. The wrapper class
...
[PreTrainedModel](https://huggingface.co/docs/transformers/v5.4.0/en/main_classes/model#transformers.PreTrainedModel)) — The parent class of the wrapped model. This should be set totransformers.AutoModelForCausalLM
...
forward
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/modeling_value_head.py#L703)
...
generate
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/modeling_value_head.py#L758)
( *args **kwargs )
...
_init_weights
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/modeling_value_head.py#L681)
( **kwargs )
...
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/modeling_value_head.py#L838)
( pretrained_model **kwargs )
Parameters
...
.
forward
[< source >](https://github.com/huggingface/trl/blob/v1.0.0/trl/experimental/ppo/modeling_value_head.py#L969)
( input_ids = None past_key_values = None attention_mask = None return_past_key_values = False **kwargs )
We call generate
