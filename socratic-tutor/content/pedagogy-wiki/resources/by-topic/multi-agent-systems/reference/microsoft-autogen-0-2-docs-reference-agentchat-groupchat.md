...
select_speaker_msg[](#select_speaker_msg)
...
a_select_speaker[](#a_select_speaker)
...
a_auto_select_speaker[](#a_auto_select_speaker)
...
Returns:
- Tuple[ConversableAgent, Dict]: A tuple containing the last agent who spoke and their message
messages_from_string[](#messages_from_string)
...
messages_to_string[](#messages_to_string)
...
clear_agents_history[](#clear_agents_history)
