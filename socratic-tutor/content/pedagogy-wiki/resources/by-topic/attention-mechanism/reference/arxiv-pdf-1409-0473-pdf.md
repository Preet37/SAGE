...
zi = σ (Wz e(yi−1) + Uz si−1 + Cz ci) ,ri = σ (Wr e(yi−1) + Ur si−1 + Cr ci) ,
...
˜si = tanh ( W Ey i−1 + U [ri ◦ si−1] + Cc i)

zi =σ (Wz Ey i−1 + Uz si−1 + Cz ci)

ri =σ (Wr Ey i−1 + Ur si−1 + Cr ci)
