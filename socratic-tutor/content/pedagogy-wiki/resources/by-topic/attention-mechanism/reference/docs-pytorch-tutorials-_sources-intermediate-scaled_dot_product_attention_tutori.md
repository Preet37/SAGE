...
# Title: Scaled Dot Product Attention tutorial (PyTorch tutorial source)
# Fetched via: browser
# Date: 2026-04-09
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    tensor([[[-0.7577, -0.4501,  0.7666, -0.3788, -1.4788, -0.3538,  0.8328,
               1.5038],
             [-1.1391, -0.4157,  0.9141, -0.5807, -1.1358,  0.1029,  0.5517,
               1.0679],
             [-1.3630, -0.1305,  0.9008, -0.6974, -0.7579,  1.1082,  0.3930,
               0.7220]],

            [[ 0.5819,  0.7305, -0.0390,  0.3708, -0.6366, -0.4832, -0.1858,
              -0.8426],
             [ 0.3529,  0.9572, -0.1510,  0.7856, -0.4566, -0.0342, -0.4596,
              -0.5875],
             [ 0.2802,  1.0093, -0.2846,  0.8387, -0.3256,  0.1653, -0.4038,
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    The default implementation runs in 2333.687 microseconds
    The math implementation runs in 87407.322 microseconds
    The flash attention implementation runs in 2316.913 microseconds
    The memory efficient implementation runs in 4577.936 microseconds
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Random NT runs in 599.388 microseconds
    Random Dense runs in 964.192 microseconds
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    The non compiled module runs in  429.532 microseconds
    The compiled module runs in  522.568 microseconds
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    -------------------------------------------------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  
                             Non-Compilied Causal Attention        17.15%       2.168ms        72.22%       9.131ms       9.131ms       0.000us         0.00%      10.831ms      10.831ms             1  
                             Non-Compilied Causal Attention         0.00%       0.000us         0.00%       0.000us       0.000us      10.693ms       100.80%      10.693ms      10.693ms             1  
                                               aten::linear         0.87%     110.077us        32.99%       4.171ms      83.425us       0.000us         0.00%       8.025ms     160.505us            50  
                                               aten::matmul         1.71%     215.741us        29.87%       3.776ms      75.524us       0.000us         0.00%       8.025ms     160.505us            50  
                                                   aten::mm         9.04%       1.143ms        26.35%       3.331ms      66.626us       7.802ms        73.55%       8.025ms     160.505us            50  
             ampere_fp16_s1688gemm_fp16_128x128_ldg8_f2f_tn         0.00%       0.000us         0.00%       0.000us       0.000us       5.580ms        52.61%       5.580ms     223.215us            25  
                         aten::scaled_dot_product_attention         1.65%     208.411us        14.77%       1.867ms      74.695us       0.000us         0.00%       2.806ms     112.227us            25  
                  aten::_scaled_dot_product_flash_attention         2.32%     293.237us        13.12%       1.659ms      66.359us       0.000us         0.00%       2.806ms     112.227us            25  
                             aten::_flash_attention_forward         2.44%     308.032us         9.66%       1.222ms      48.867us       2.806ms        26.45%       2.806ms     112.227us            25  
    void pytorch_flash::flash_fwd_kernel<Flash_fwd_kerne...         0.00%       0.000us         0.00%       0.000us       0.000us       2.806ms        26.45%       2.806ms     112.227us            25  
    -------------------------------------------------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  
    Self CPU time total: 12.643ms
    Self CUDA time total: 10.608ms

    -------------------------------------------------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  
                                                       Name    Self CPU %      Self CPU   CPU total %     CPU total  CPU time avg     Self CUDA   Self CUDA %    CUDA total  CUDA time avg    # of Calls  
    -------------------------------------------------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  
                                  Compiled Causal Attention         0.00%       0.000us         0.00%       0.000us       0.000us      10.677ms       100.75%      10.677ms      10.677ms             1  
                                  Compiled Causal Attention         6.59%     841.520us        72.42%       9.247ms       9.247ms       0.000us         0.00%      10.597ms      10.597ms             1  
                                 Torch-Compiled Region: 0/0         6.21%     793.402us        62.24%       7.947ms     317.866us       0.000us         0.00%      10.597ms     423.900us            25  
                                           CompiledFunction        19.65%       2.509ms        56.03%       7.153ms     286.130us       0.000us         0.00%      10.597ms     423.900us            25  
                                                   aten::mm         6.52%     832.660us        10.54%       1.345ms      26.907us       7.797ms        73.57%       7.797ms     155.931us            50  
             ampere_fp16_s1688gemm_fp16_128x128_ldg8_f2f_tn         0.00%       0.000us         0.00%       0.000us       0.000us       5.571ms        52.57%       5.571ms     222.839us            25  
                  aten::_scaled_dot_product_flash_attention         1.73%     220.285us        12.17%       1.554ms      62.170us       0.000us         0.00%       2.801ms     112.038us            25  
                             aten::_flash_attention_forward         2.46%     313.724us         9.03%       1.153ms      46.107us       2.801ms        26.43%       2.801ms     112.038us            25  
    void pytorch_flash::flash_fwd_kernel<Flash_fwd_kerne...         0.00%       0.000us         0.00%       0.000us       0.000us       2.801ms        26.43%       2.801ms     112.038us            25  
    ampere_fp16_s1688gemm_fp16_128x128_ldg8_f2f_stages_3...         0.00%       0.000us         0.00%       0.000us       0.000us       2.226ms        21.00%       2.226ms      89.023us            25  
    -------------------------------------------------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  ------------  
    Self CPU time total: 12.768ms
