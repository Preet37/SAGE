...
# Author: OpenAI
# Author Slug: openai
# Title: OpenAI API Documentation (Platform docs)
# Fetched via: jina
# Date: 2026-04-09
...
[Get started](https://platform.openai.com/api/docs/quickstart)
...
[View all](https://platform.openai.com/api/docs/models)

[GPT-5.4 New Best intelligence at scale for agentic, coding, and professional workflows](https://platform.openai.com/api/docs/models/gpt-5.4)[GPT-5.4 mini New Our strongest mini model yet for coding, computer use, and subagents](https://platform.openai.com/api/docs/models/gpt-5.4-mini)[GPT-5.4 nano New Our cheapest GPT-5.4-class model for simple high-volume tasks](https://platform.openai.com/api/docs/models/gpt-5.4-nano)

## Start building

[Read and generate text Use the API to prompt a model and generate text](https://platform.openai.com/api/docs/guides/text)[Use a model's vision capabilities Allow models to see and analyze images in your application](https://platform.openai.com/api/docs/guides/images-vision)[Generate images as output Create images with GPT Image 1](https://platform.openai.com/api/docs/guides/image-generation)[Build apps with audio Analyze, transcribe, and generate audio with API endpoints](https://platform.openai.com/api/docs/guides/audio)[Build agentic applications Use the API to build agents that use tools and computers](https://platform.openai.com/api/docs/guides/agents)[Achieve complex tasks with reasoning Use reasoning models to carry out complex tasks](https://platform.openai.com/api/docs/guides/reasoning)[Get structured data from models Use Structured Outputs to get model responses that adhere to a JSON schema](https://platform.openai.com/api/docs/guides/structured-outputs)[Tailor to your use case Adjust our models to perform specifically for your use case with fine-tuning, evals, and distillation](https://platform.openai.com/api/docs/guides/model-optimization)

[Help center Frequently asked account and billing questions](https://help.openai.com/)[Developer forum Discuss topics with other developers](https://community.openai.com/)[Cookbook Open-source collection of examples and guides](https://platform.openai.com/cookbook)[Status Check the status of OpenAI services](https://status.openai.com/)