...
# Author: OpenAI
# Author Slug: openai
# Title: OpenAI Docs: DALL·E 3 model documentation
# Fetched via: jina
# Date: 2026-04-09

Title: DALL·E 3 Model | OpenAI API


# DALL·E 3 Model | OpenAI API
...
Pricing is based on the number of tokens used, or other metrics based on the model type. For tool-specific models, like search and computer use, there’s a fee per tool call. See details in the[pricing page](https://platform.openai.com/api/docs/pricing).
