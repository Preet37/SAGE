...
# Title: Quality of Service settings — ROS 2 Documentation
...
If you want up-to-date information, please have a look at [Kilted](../../../kilted/Concepts/Intermediate/About-Quality-of-Service-Settings.html).
Quality of Service settings[](#quality-of-service-settings)
[Overview](#id2)[](#overview)
...
[Comparison to ROS 1](#id4)[](#comparison-to-ros-1)
The “history” and “depth” policies in ROS 2 combine to provide functionality akin to the queue size in ROS 1.
The “reliability” policy in ROS 2 is akin to the use of either UDPROS (only in roscpp
) for “best effort”, or TCPROS (ROS 1 default) for “reliable”.
...
[Click here](https://github.com/ros2/rmw/blob/iron/rmw/include/rmw/qos_profiles.h) for the specific policies in use for the above profiles.
The settings in these profiles are subject to further tweaks, based on the feedback from the community.
[QoS compatibilities](#id6)[](#qos-compatibilities)
...
[Matched events](#id9)[](#matched-events)
