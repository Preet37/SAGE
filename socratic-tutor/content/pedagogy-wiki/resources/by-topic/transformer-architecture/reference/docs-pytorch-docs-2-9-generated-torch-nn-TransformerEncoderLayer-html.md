...
# Title: torch.nn.TransformerEncoderLayer — PyTorch 2.9 documentation
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.9.1/torch/nn/modules/transformer.py#L645)[#](#torch.nn.TransformerEncoderLayer) TransformerEncoderLayer is made up of self-attn and feedforward network.
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.9.1/torch/nn/modules/transformer.py#L781)[#](#torch.nn.TransformerEncoderLayer.forward) Pass the input through the encoder layer.
- Parameters
src (
