...
# Title: torch.nn.TransformerEncoderLayer — PyTorch 2.8 documentation
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/transformer.py#L645)[#](#torch.nn.TransformerEncoderLayer) TransformerEncoderLayer is made up of self-attn and feedforward network.
...
[[source]](https://github.com/pytorch/pytorch/blob/v2.8.0/torch/nn/modules/transformer.py#L781)[#](#torch.nn.TransformerEncoderLayer.forward) Pass the input through the encoder layer.
- Parameters
src (
[Tensor](../tensors.html#torch.Tensor)) – the sequence to the encoder layer (required).src_mask (
[Optional](https://docs.python.org/3/library/typing.html#typing.Optional)[[Tensor](../tensors.html#torch.Tensor)]) – the mask for the src sequence (optional).src_key_padding_mask (
[Optional](https://docs.python.org/3/library/typing.html#typing.Optional)[[Tensor](../tensors.html#torch.Tensor)]) – the mask for the src keys per batch (optional).is_causal (
