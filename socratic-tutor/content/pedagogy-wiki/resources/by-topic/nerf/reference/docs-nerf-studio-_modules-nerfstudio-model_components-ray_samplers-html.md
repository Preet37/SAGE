...
# Title: Source code for nerfstudio.model_components.ray_samplers
# Fetched via: trafilatura
# Date: 2026-04-09

Source code for nerfstudio.model_components.ray_samplers
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.Sampler)class Sampler(nn.Module):
"""Generate Samples
Args:
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.Sampler.forward) def forward(self, *args, **kwargs) -> Any:
"""Generate ray samples"""
return self.generate_ray_samples(*args, **kwargs)
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.SpacedSampler)class SpacedSampler(Sampler):
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.SpacedSampler.generate_ray_samples) def generate_ray_samples(
self,
...
return ray_samples
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.UniformSampler)class UniformSampler(SpacedSampler):
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.LinearDisparitySampler)class LinearDisparitySampler(SpacedSampler):
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.SqrtSampler)class SqrtSampler(SpacedSampler):
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.LogSampler)class LogSampler(SpacedSampler):
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.UniformLinDispPiecewiseSampler)class UniformLinDispPiecewiseSampler(SpacedSampler):
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.PDFSampler)class PDFSampler(Sampler):
...
self.single_jitter = single_jitter
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.PDFSampler.generate_ray_samples) def generate_ray_samples(
self,
ray_bundle: Optional[RayBundle] = None,
...
return ray_samples
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.DensityFn)class DensityFn(Protocol):
"""
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.VolumetricSampler)class VolumetricSampler(Sampler):
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.VolumetricSampler.get_sigma_fn) def get_sigma_fn(self, origins, directions, times=None) -> Optional[Callable]:
...
return sigma_fn
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.VolumetricSampler.generate_ray_samples) def generate_ray_samples(self) -> RaySamples:
raise RuntimeError(
"The VolumetricSampler fuses sample generation and density check together. Please call forward() directly."
)
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.VolumetricSampler.forward) def forward(
self,
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.ProposalNetworkSampler)class ProposalNetworkSampler(Sampler):
...
self._step = 0
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.ProposalNetworkSampler.set_anneal) def set_anneal(self, anneal: float) -> None:
"""Set the anneal value for the proposal network."""
self._anneal = anneal
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.ProposalNetworkSampler.step_cb) def step_cb(self, step):
"""Callback to register a training step has passed. This is used to keep track of the sampling schedule"""
self._step = step
self._steps_since_update += 1
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.ProposalNetworkSampler.generate_ray_samples) def generate_ray_samples(
self,
ray_bundle: Optional[RayBundle] = None,
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.NeuSSampler)class NeuSSampler(Sampler):
...
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.NeuSSampler.generate_ray_samples) def generate_ray_samples(
self,
ray_bundle: Optional[RayBundle] = None,
...
total_iters += 1
return ray_samples
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.NeuSSampler.rendering_sdf_with_fixed_inv_s) @staticmethod
...
return alpha
[[docs]](../../../reference/api/model_components/ray_sampler.html#nerfstudio.model_components.ray_samplers.NeuSSampler.merge_ray_samples) @staticmethod
