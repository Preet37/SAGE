...
*   [Enable streaming](https://platform.openai.com/docs/api-reference/streaming#enable-streaming)
*   [Read the responses](https://platform.openai.com/docs/api-reference/streaming#read-the-responses)
*   [Advanced use cases](https://platform.openai.com/docs/api-reference/streaming#advanced-use-cases)
*   [Moderation risk](https://platform.openai.com/docs/api-reference/streaming#moderation-risk)
...
This guide focuses on HTTP streaming (`stream=true`) over server-sent events (SSE). For persistent WebSocket transport with incremental inputs via `previous_response_id`, see [the Responses API WebSocket mode](https://platform.openai.com/api/docs/guides/websocket-mode).
...
For a full list of event types, see the [API reference for streaming](https://platform.openai.com/api/docs/api-reference/responses-streaming). Here are a few examples:
...
Streaming Chat Completions is fairly straightforward. However, we recommend using the [Responses API for streaming](https://platform.openai.com/api/docs/guides/streaming-responses?api-mode=responses), as we designed it with streaming in mind. The Responses API uses semantic events for streaming and is type-safe.
...
For a full list of events you can listen for, see the [API reference for streaming](https://platform.openai.com/api/docs/api-reference/responses-streaming).
...
*   [Streaming function calls](https://platform.openai.com/api/docs/guides/function-calling#streaming)
*   [Streaming structured output](https://platform.openai.com/api/docs/guides/structured-outputs#streaming)
